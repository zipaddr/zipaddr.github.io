function Vli(){
/*	■日付データの入力編集＆チェック処理( validate5.js Ver5.31 )
 *
 *	The use is charged.  // ご利用は無料です。
 *	@demo    https://validate-js.com/demo/
 *	@link    https://pierre-soft.com/
