function zipaddr_ownpm(){     //Visual Forms Builder用
	const ver="1.1";
	let ans= new Array();
...
//Set
	if( typeof ZP.tel != "undefined" ) ZP.tel[1]= zipaddr_ownpm_tag("label","Phone");
...
//	if( typeof ZP.mei != "undefined" ) ZP.mei[1]= zipaddr_ownpm_tag("label","名");
	if( typeof ZP.simei!="undefined" )ZP.simei[1]=zipaddr_ownpm_tag("label","名前");
	pm= new Array();
